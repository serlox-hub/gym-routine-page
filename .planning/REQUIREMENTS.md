...
- [ ] **STOR-01**: `createWorkoutStore(storage)` factory in `packages/shared/src/stores/`
- [ ] **STOR-02**: `createAuthStore(supabase, storage)` factory in `packages/shared/src/stores/`
