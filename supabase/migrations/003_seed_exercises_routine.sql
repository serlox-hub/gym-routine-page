...
INSERT INTO exercises (nombre, equipment_id, grip_type_id, grip_width_id, altura_polea) VALUES
    ('Rueda Abdominal', 13, NULL, NULL, NULL),
    ('Bicho Muerto', 11, NULL, NULL, NULL),
    ('Press Pallof', 6, 3, 1, 'Media'),
    ('Perro-Pájaro Lento', 11, NULL, NULL, NULL),
    ('Crunch en Polea', 6, 3, 1, 'Alta'),
    ('Plancha Lateral', 11, NULL, NULL, NULL),
    ('Hollow Body Hold', 11, NULL, NULL, NULL),
    ('Paseo del Granjero', 5, 3, 4, NULL);
