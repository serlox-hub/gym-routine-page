...
export function useCreateExercise() {
  ...
  return useMutation({
    mutationFn: ({ exercise, muscleGroupId }) =>
      createExercise({ userId, exercise, muscleGroupId }),
    onSuccess: () => {
...
export function useUpdateExercise() {
  ...
  return useMutation({
    mutationFn: ({ exerciseId, exercise, muscleGroupId }) =>
      updateExercise({ exerciseId, exercise, muscleGroupId }),
    onSuccess: (data) => {
      queryClient.invalidateQueries({ queryKey: [QUERY_KEYS.EXERCISES] })
