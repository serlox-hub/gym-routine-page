...
import { getMuscleGroupColor, getMuscleGroupName, normalizeSearchText } from '@gym/shared'
              ...
              >
                <div className="flex items-center gap-2 font-medium">
                  <span
                    ...
                    title={exercise.muscle_group ? getMuscleGroupName(exercise.muscle_group) : undefined}
                  />
                  {exercise.name}
                </div>
                {isInRoutine && (
