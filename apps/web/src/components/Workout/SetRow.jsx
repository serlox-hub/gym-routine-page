...
function SetRow({
  ...
  // Lo lleva el CONTENEDOR del bloque (fila de valores + subfila de contexto), no el grid: es lo
  ...
  return (
    <>
      {/* Bloque de la serie: la fila de valores y su subfila de contexto comparten UN contenedor
          ...
          El inset izquierdo (borde + px-1) lo pone SOLO este contenedor: el grid interior no
      ...
      <div className="px-1 rounded-lg" style={baseRowStyle}>
        <div
